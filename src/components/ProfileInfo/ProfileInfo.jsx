...
const ProfileInfo = (props) => {
    ...
    const saveUserProfile = (userProfileFormData) => {
        ...
        // props.updateUserProfile(userProfileFormData);
        // setEditMode(false);
    }

    const isOwner = props.userProfile.userId === props.authData.userId;

    return (editMode ? <EditProfileForm onSubmit={saveUserProfile} uploadProfilePhoto={props.uploadProfilePhoto}
            ...
            <div className={s.profileInfoWrapper}>
                ...
                <div className={s.profileInfoRight}>
                    <div className={s.profileInfoJob}>
                        ...
                        <div className={s.profileField}>
                            <b>Looking for a job:</b> <span>{props.userProfile.lookingForAJob ? "YES" : "NO"}</span>
                        </div>
                        <div className={s.profileField}>
                            <b>Job description:</b> <span>{props.userProfile.lookingForAJobDescription}</span>
                        </div>
                    </div>
